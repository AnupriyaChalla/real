...
if (isset($_POST['location']) && isset($_POST['description']) && isset($_POST['price'])) {
    ...
    $price = ($_POST['price']); // Convert price to float (or use appropriate data type as per your database)
    ...
    $stmt = $conn->prepare("INSERT INTO resi_images (Location, Description, Price, Image1, Image2, Image3, Image4, Image5, Image6, Image7, Image8, Video)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    if (!$stmt) {
